...
const EditPrescription = () => {
  ...
  const [editedPrescriptionId, setEditedPrescriptionId] = useState(-1);
  ...
  const handleOnSubmit = async (event) => {
    ...
    try {
      console.log({ state });
      if (editedPrescriptionId !== -1) {
        const { data } = await axios.post(
          `${BASE_API_URL}/prescription/${editedPrescriptionId}`,
          {
            ...state,
            _id: editedPrescriptionId,
            ...
            <div className="first-form">
              <Form.Group className="mb-3" controlId="doctor">
                ...
                <Form.Select
                  ...
                  disabled={editedPrescriptionId !== -1}
                >
              ...
              <Form.Group className="mb-3">
                <Button variant="primary" type="submit">
                  {editedPrescriptionId !== -1 ? "Update" : "Add"}
                </Button>
              </Form.Group>
            </div>
